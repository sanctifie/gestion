        ...
        <div id="content">
			<div class="container">
                ...
                <div class="col-sm-9" id="blog-post">
									...
									$sql = "SELECT * from seminaire f join imagess i on f.id=i.id_seminaire join salle s on f.id_salle=s.id join user u on f.id_users=u.id  where f.id='$id_formation' GROUP BY i.id_seminaire ";
                    ...
                    <div class="box">
                        ...
                        <h1><?php echo htmlentities($result->seminaireTitle);?></h1>



                        <div id="post-content">

                                <img src="admin/images/seminaire/<?php echo htmlentities($result->image_sem);?>" class="img-responsive"  alt="Example blog post alt">
                            </p><br><br>
                            ...
                            <blockquote><p><?php echo htmlentities($result->seminaireOverview);?></p><blockquote>
                    ...
                    <div class="panel panel-default sidebar-menu" style="background-color: #232f68;">
							...
							<div class="panel-heading" style="background-color: #232f68;">
								<?php	if(isset($_SESSION['auth'])) : ?>
									<?php if(users_has_already_like_the_sem($id_formation)): ?>
										<a  href="traitement_napp.php?id_formation=<?php echo $id_formation ;?>&amp;id_apprenant=<?php echo $_SESSION['auth']->id ;?>" class="btn btn-primary"><i class="fa fa-comment-o">Annuler</i></a>
								<?php else: ?>
										<a  href="traitement_ap.php?id_formation=<?php echo $id_formation ;?>&amp;id_apprenant=<?php echo $_SESSION['auth']->id ;?>" class="btn btn-primary"><i class="fa fa-comment-o">S'inscrire</i></a>
									<?php endif; ?>
								<?php else: ?>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
								...
								<li style="text-align:center;">
                                   <span style="color:white;"> <?php echo htmlentities($result->seminairedeb);?></span/>
                                </li>
								<hr/>
								<li style="text-align:center;">
								...
								<li style="text-align:center;">
                                   <span style="color:white;"> <?php echo htmlentities($result->seminairefin);?></span>
                                </li>
								<hr/>
