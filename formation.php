...
<?php include('includes/header2.php');?>
		...
		<div class="col-lg-36 text-center">
				<h2 class="big-title small-margin">Toutes les Séminaires</h2>
		</div>
	...
	<div class="navigation-left">
		...
		<div class="navigation-block total-count">
			...
			$sql = "SELECT id from seminaire WHERE status='0'";
	...
	<div class="navigation-right">
		...
		<div class="col-md-12">
			...
			<?php
									...
									$sql = "SELECT * from seminaire f join imagess i on f.id=i.id_seminaire join salle s on f.id_salle=s.id join user u on f.id_users=u.id WHERE f.status = '0' GROUP BY i.id_seminaire ORDER BY f.RegDate DESC $limit";
									$query = $dbh -> prepare($sql);
									$query->execute();
									$results=$query->fetchAll(PDO::FETCH_OBJ);
									$pagination = '';
								...
								<a href="seminaire-details.php?id_formation=<?php echo $result->id_seminaire;?>">
									<div class="top">
											<div class="type">
												...
												<img src="admin/images/seminaire/<?php echo htmlentities($result->image_sem);?>" class="img-fluid" alt="">
